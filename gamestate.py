...
class GameState(object):
    ...
    def _initialize_squares():
        PROP_MEDITERRANEAN = ColorProperty(
        ...
        PROP_CONNECTICUT = ColorProperty(
        ...
        PROP_READING_RAILROAD = NonColorProperty(
        ...
        PROP_B_AND_O_RAILROAD = NonColorProperty(
        ...
        PROP_SHORT_LINE = NonColorProperty(
            name=SHORT_LINE_RAILROAD,
            price=200,
            rents=[25, 50, 100, 200],
            property_group=RAILROAD,
            size_of_property_group=4,
        ...
        PROP_ELECTRIC_COMPANY = NonColorProperty(
        ...
        PROP_WATER_WORKS = NonColorProperty(
            name=WATER_WORKS,
            price=150,
            rents=[-1, -1],
            property_group=UTILITY,
    ...
    def get_property_group(self, prop_group):
        property_group = [
            square
            if isinstance(square, Property) and square.property_group == prop_group
            else None
    ...
    def _apply_single_change(self, change):
        ...
        ) in change.change_in_jail_free_count.items():
